...
Dependencies listed in `ML_Project/requirements.txt`:
- pandas
- numpy
- seaborn
- scikit-learn
...
4. Add Dockerfile and deployment pipeline for cloud hosting.
5. Improve frontend styling and user input feedback/validation messages.
6. Version artifacts with timestamp/hash-based model registry pattern.
7. Add API endpoint versioning and health-check endpoint.
